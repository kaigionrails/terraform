...
resource "aws_ssm_parameter" "cfp_app_database_url_apne1" {
  name  = "/cfp-app/DATABASE_URL"
  type  = "SecureString"
  value = "DATABASE_URL"
  lifecycle {
...
resource "aws_ssm_parameter" "cfp_app_github_secret_apne1" {
  name  = "/cfp-app/GITHUB_SECRET"
  type  = "SecureString"
  value = "GITHUB_SECRET"
  lifecycle {
...
resource "aws_ssm_parameter" "cfp_app_redis_tls_url_apne1" {
  name  = "/cfp-app/REDIS_TLS_URL"
  type  = "SecureString"
  value = "REDIS_TLS_URL"
  lifecycle {
...
resource "aws_ssm_parameter" "cfp_app_redis_url_apne1" {
  name  = "/cfp-app/REDIS_URL"
  type  = "SecureString"
  value = "REDIS_URL"
  lifecycle {
...
resource "aws_ssm_parameter" "cfp_app_secret_key_base_apne1" {
  name  = "/cfp-app/SECRET_KEY_BASE"
  type  = "SecureString"
  value = "SECRET_KEY_BASE"
  lifecycle {
...
resource "aws_ssm_parameter" "cfp_app_sentry_dsn_apne1" {
  name  = "/cfp-app/SENTRY_DSN"
  type  = "SecureString"
  value = "SENTRY_DSN"
  lifecycle {
...
resource "aws_ssm_parameter" "cfp_app_slack_webhook_url_apne1" {
  name  = "/cfp-app/SLACK_WEBHOOK_URL"
  type  = "SecureString"
  value = "SLACK_WEBHOOK_URL"
  lifecycle {
...
resource "aws_ssm_parameter" "cfp_app_smtp_address_apne1" {
  name  = "/cfp-app/SMTP_ADDRESS"
  type  = "SecureString"
  value = "SMTP_ADDRESS"
  lifecycle {
...
resource "aws_ssm_parameter" "cfp_app_smtp_domain_apne1" {
  name  = "/cfp-app/SMTP_DOMAIN"
  type  = "SecureString"
  value = "SMTP_DOMAIN"
  lifecycle {
...
resource "aws_ssm_parameter" "cfp_app_smtp_password_apne1" {
  name  = "/cfp-app/SMTP_PASSWORD"
  type  = "SecureString"
  value = "SMTP_PASSWORD"
  lifecycle {
...
resource "aws_ssm_parameter" "cfp_app_smtp_username_apne1" {
  name  = "/cfp-app/SMTP_USERNAME"
  type  = "SecureString"
  value = "SMTP_USERNAME"
  lifecycle {
...
resource "aws_ssm_parameter" "cfp_app_twitter_key_apne1" {
  name  = "/cfp-app/TWITTER_KEY"
  type  = "SecureString"
  value = "TWITTER_KEY"
  lifecycle {
...
resource "aws_ssm_parameter" "cfp_app_twitter_secret_apne1" {
  name  = "/cfp-app/TWITTER_SECRET"
  type  = "SecureString"
  value = "TWITTER_SECRET"
  lifecycle {
